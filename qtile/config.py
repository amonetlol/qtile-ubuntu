    ...
    Screen(
        top = bar.Bar([
            ...
            widget.Image(
                ...
                margin = 7,
                mouse_callbacks = {'Button1': lazy.spawn("alacritty -e sudo apt update")},
                decorations = [
                    RectDecoration(
                        colour = colors["green"],
                        **decoration_defaults,
            ...
            widget.Image(
                filename = '~/.config/qtile/assets/logout.png',
                margin = 7,
                mouse_callbacks = {'Button1': lazy.spawn("alacritty -e pkill -KILL -u pio")},
                decorations = [
                    RectDecoration(
                        colour = colors["white"],
                        **decoration_defaults,
            ...
            widget.Image(
                ...
                margin = 7,
                mouse_callbacks = {'Button1': lazy.spawn("alacritty -e reboot now")},
                decorations = [
                    RectDecoration(
                        colour = colors["white"],
                        **decoration_defaults,
            ...
            widget.Image(
                ...
                margin = 7,
                mouse_callbacks = {'Button1': lazy.spawn("alacritty -e shutdown now")},
                decorations = [
                    RectDecoration(
                        colour = colors["white"],
                        **decoration_defaults,
